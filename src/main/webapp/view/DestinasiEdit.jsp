...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
	...
	<div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
		...
		<% if (destinasi != null) { %>
		<form action="../exe/exeDestinasiEdit.jsp" method="POST"
			...
			<div class="flex flex-col">
				...
				<textarea id="deskripsi" name="deskripsi" rows="4"
					...
					class="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
					required><%= destinasi.getDescription() %></textarea>
			</div>
		...
		<% } else { %>
		<p class="text-center text-red-500 font-semibold">Destinasi Tidak
			Ada</p>
		<div class="text-center mt-4">
			<a href="../view/Destinasi.jsp" class="text-blue-500 hover:underline">
				Kembali ke daftar destinasi </a>
		</div>
		<% } %>
	</div>
