...
<body>
    ...
    <section class="w-full flex flex-col justify-center items-center my-6 px-4">
        ...
        <div class="w-full max-w-4xl">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-4">
                <h3 class="text-xl font-bold mb-2">Transaksi <%= ++no %></h3>
                <p class="text-gray-700 mb-2">Nama Paket: <%= pkg != null ? pkg.getName() : "N/A" %></p>
                <p class="text-gray-700 mb-2">Jumlah: <%= transaction.getQuantity() %></p>
                <p class="text-gray-700 mb-2">Total: Rp <%= transaction.getTotalAmount() %></p>
                <div class="flex gap-4">
                    ...
                    <a href="../../exe/exeTransactionDelete.jsp?id=<%= transaction.getId() %>"
